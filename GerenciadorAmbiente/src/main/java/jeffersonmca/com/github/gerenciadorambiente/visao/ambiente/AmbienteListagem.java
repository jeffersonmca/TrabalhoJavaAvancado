...
public class AmbienteListagem extends javax.swing.JFrame {
    ...
    private void jbtnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRemoverActionPerformed
        ...
        if (tableAmbientes.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Selecione um registro.", "Dica", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        
        // Pega a linha que ele selecionou e transforma em um objeto do tipo Ambiente
        Ambiente aux = dados.get(tableAmbientes.getSelectedRow());        
        ...
        // Pergunta o usuario se ele realmente quer deletar aquele Ambiente
        if (JOptionPane.showConfirmDialog(this, 
                "Confirma a remoção do ambiente: " + aux.getNome() + "?",
                "Remoção",
                JOptionPane.YES_NO_OPTION
                ) == JOptionPane.YES_OPTION ) {

            try {
                // Caso a escolha fora sim entao o Ambiente sera removido
    ...
    private void jbtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIncluirActionPerformed
        ...
        // Instancia a tela de inclusao do Ambiente
        AmbienteInclui tela = new AmbienteInclui(this, true, service);
    ...
    private void jbtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditarActionPerformed
        ...
        // Instancia a tela de edicao do Ambiente. passando de parametro
        // o servico e o Ambiente a ser editado
