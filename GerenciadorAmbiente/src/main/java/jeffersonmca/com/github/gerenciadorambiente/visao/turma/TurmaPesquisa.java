...
public class TurmaPesquisa extends javax.swing.JFrame {

    private ServicoTurma service;
    private List<Turma> dados;
    private TurmaTableModel tabModel;
    
    public TurmaPesquisa() {
        
        initComponents();
        
        this.service = new ServicoTurma();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Turma");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "ID DISCIPLINA", "ID PERIODO", "ID PROFESSOR" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Turmas");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Turmas");
