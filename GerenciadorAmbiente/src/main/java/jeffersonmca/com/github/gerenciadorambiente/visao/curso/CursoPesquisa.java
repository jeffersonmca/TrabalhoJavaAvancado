...
public class CursoPesquisa extends javax.swing.JFrame {

    private ServicoCurso service;
    private List<Curso> dados;
    private CursoTableModel tabModel;
    
    public CursoPesquisa() {
        
        initComponents();
        
        this.service = new ServicoCurso();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Curso");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "ID PERIODO" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Cursos");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Cursos");
