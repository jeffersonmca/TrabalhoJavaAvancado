...
public class CursoListagem extends javax.swing.JFrame {
    ...
    private void jbtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIncluirActionPerformed
        ...
        // Instancia a tela de inclusao do Curso
        CursoInclui tela = new CursoInclui(this, true, service);
    ...
    private void jbtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditarActionPerformed
        ...
        // Pega a linha que ele selecionou e transforma em um objeto do tipo Curso
        Curso aux = dados.get(tableCursos.getSelectedRow());
        ...
        // Instancia a tela de edicao do Curso. passando de parametro
        // o servico e o Curso a ser editado
    ...
    private void jbtnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRemoverActionPerformed
        ...
        // Pergunta o usuario se ele realmente quer deletar aquele Curso
        if (JOptionPane.showConfirmDialog(this,
            "Confirma a remoção do curso: " + aux.getNome() + "?",
            "Remoção",
            JOptionPane.YES_NO_OPTION
        ) == JOptionPane.YES_OPTION ) {

            try {
                // Caso a escolha fora sim entao o Curso sera removido
