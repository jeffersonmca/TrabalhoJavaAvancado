...
public class DisciplinaPesquisa extends javax.swing.JFrame {

    private ServicoDisciplina service;
    private List<Disciplina> dados;
    private DisciplinaTableModel tabModel;
    
    public DisciplinaPesquisa() {
        
        initComponents();
        
        this.service = new ServicoDisciplina();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa de Disciplina");

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        ComboBoxOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEM FILTRO", "CODIGO", "NOME", "CARGA HORARIA", "ID CURSO" }));
    ...
    private void buttonVisualizarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVisualizarRelatorioActionPerformed
        ...
        try {
            ...
            g.configuraRelatorio(true, "Disciplinas");
    ...
    private void buttonImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonImprimirRelatorioActionPerformed
        ...
        try {
            ...
            GerenciaRelatorio g = new GerenciaRelatorio();
            g.configuraRelatorio(false, "Disciplinas");
