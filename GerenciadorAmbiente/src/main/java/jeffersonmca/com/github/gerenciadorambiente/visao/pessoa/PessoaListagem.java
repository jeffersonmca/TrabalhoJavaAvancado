...
public class PessoaListagem extends javax.swing.JFrame {
    ...
    private void jbtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIncluirActionPerformed
        ...
        // Instancia a tela de inclusao do Pessoa
        PessoaInclui tela = new PessoaInclui(this, true, service);
    ...
    private void jbtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnEditarActionPerformed
        ...
        if (tablePessoas.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Selecione um registro.", "Dica", JOptionPane.INFORMATION_MESSAGE);
            return;
        }

        // Pega a linha que ele selecionou e transforma em um objeto do tipo Pessoa
        Pessoa aux = dados.get(tablePessoas.getSelectedRow());
        ...
        // Instancia a tela de edicao do Pessoa. passando de parametro
        // o servico e o Pessoa a ser editado
        PessoaEdita tela = new PessoaEdita(this, true, service, aux);
        tela.setVisible(true);
    ...
    private void jbtnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRemoverActionPerformed
        ...
        // Pergunta o usuario se ele realmente quer deletar aquele Pessoa
        if (JOptionPane.showConfirmDialog(this,
            "Confirma a remoção da pessoa: " + aux.getNome() + "?",
            "Remoção",
            JOptionPane.YES_NO_OPTION
        ) == JOptionPane.YES_OPTION ) {

            try {
                // Caso a escolha fora sim entao o Pessoa sera removido
