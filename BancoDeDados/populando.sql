...
INSERT INTO `GerenciadorAmbiente`.`LOGIN` (`log_id`, `log_senha`, `log_pesCodigo`) VALUES ('adm', 'adm', '1');
...
INSERT INTO `GerenciadorAmbiente`.`ALUNO_TURMA` (`aluno_id`, `turma_id`) VALUES ('2', '1');
INSERT INTO `GerenciadorAmbiente`.`ALUNO_TURMA` (`aluno_id`, `turma_id`) VALUES ('3', '2');
INSERT INTO `GerenciadorAmbiente`.`ALUNO_TURMA` (`aluno_id`, `turma_id`) VALUES ('4', '2');

INSERT INTO `GerenciadorAmbiente`.`AULA` (`aul_enumDiaSemana`, `aul_horarioInicio`, `aul_horarioTermino`, `aul_ambCodigo`, `aul_turCodigo`) VALUES ('SEGUNDA', '13:30', '15:50', '1', '2');
INSERT INTO `GerenciadorAmbiente`.`AULA` (`aul_enumDiaSemana`, `aul_horarioInicio`, `aul_horarioTermino`, `aul_ambCodigo`, `aul_turCodigo`) VALUES ('TERCA', '10:20', '12:20', '1', '1');
INSERT INTO `GerenciadorAmbiente`.`AULA` (`aul_enumDiaSemana`, `aul_horarioInicio`, `aul_horarioTermino`, `aul_ambCodigo`, `aul_turCodigo`) VALUES ('TERCA', '18:30', '20:30', '4', '3');